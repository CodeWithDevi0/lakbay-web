...
<template>
  <div class="min-h-screen bg-gray-50/50 pb-24 font-sans">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 -mt-20 relative z-20">
      ...
      <div class="max-w-2xl mx-auto bg-gradient-to-br from-[#f8fdfd] to-[#e6f4f4] rounded-2xl p-8 border border-teal-100 relative shadow-sm">
        ...
        <p class="text-gray-600 font-medium italic mb-4 text-sm sm:text-base leading-relaxed">
          "Premium totally changed how we plan trips! The route optimization saved us hours, and offline maps were a lifesaver in Palawan!"
        </p>
        <p class="text-gray-400 text-xs font-bold uppercase tracking-wider">- Maria Santos, Frequent Traveler</p>
      </div>
