...
const tasks = ref([
  { id: 1, title: 'Reserve island hopping tour', assignee: 'Stephanie', status: 'Pending', dueDate: 'Dec 18', avatar: 'https://i.pravatar.cc/100?u=steph' },
  { id: 2, title: 'Buy travel insurance', assignee: 'Arjean', status: 'Pending', dueDate: 'Dec 19', avatar: 'https://i.pravatar.cc/100?u=arjean' },
  { id: 3, title: 'Book Flight Tickets', assignee: 'YuKen', status: 'Completed', dueDate: 'Dec 10', avatar: 'https://i.pravatar.cc/100?u=yuken' }
]);
</script>
  ...
  <div class="w-full space-y-8">
    ...
    <div class="grid grid-cols-2 gap-4">
      <div class="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-sm">
        ...
        <p class="text-3xl font-extrabold text-[#D97736]">2</p>
      </div>
      <div class="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-sm">
        <p class="text-xs font-bold text-gray-400 uppercase mb-1">Completed</p>
        <p class="text-3xl font-extrabold text-[#2A8B8B]">1</p>
      </div>
    </div>
    ...
    <div class="space-y-4">
      <div class="flex items-center gap-2 mb-2">
        ...
        <h3 class="text-sm font-bold text-gray-700 uppercase tracking-wider">Pending (2)</h3>
      </div>
        ...
        <div class="flex-grow">
          ...
          <div class="flex flex-wrap gap-2">
            ...
            <div class="bg-orange-50 px-3 py-1.5 rounded-full border border-orange-100 flex items-center gap-1.5">
              <span class="text-[11px] font-bold text-[#D97736]">Due: {{ task.dueDate }}</span>
